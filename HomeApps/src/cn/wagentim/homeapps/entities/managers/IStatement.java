...
public interface IStatement
{
	...
	public static final String GET_ORDERS_BY_USER = "select o from OrderEntity o WHERE o.owner = :user_id";
	public static final String GET_ORDER_ITEM = "select item from OrderItemEntity item WHERE item.id = :item_id";
	public static final String DELETE_ALL_ORDERS = "DELETE from OrderEntity o WHERE o.owner = :user_id";
}
